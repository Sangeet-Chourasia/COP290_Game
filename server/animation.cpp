...
SDL_Point player_point{239,81};
SDL_Rect player{239-player_x/2,81-player_y/2,player_x,player_y};

SDL_Rect player_frame2{0,0,SCREEN_WIDTH/2,SCREEN_HEIGHT/2};
SDL_Point player_point2{207,423};
SDL_Rect player2{207-player_x/2,423-player_y/2,player_x,player_y};
    ...
    while(game_running)
    {
        ...
        if (accum_anim_time >= kAnim_frame_delay)
        {
            ...
            if(multiplayer)
            {
                ...
                send_message(str,new_socket,valread);
